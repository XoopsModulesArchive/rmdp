...
//////////////////////////////////////////////////////////////////////////////
// $Id: rmdp_access.php,v 1.5 23/11/2005 13:45:28 BitC3R0 Exp $             //
// ------------------------------------------------------------------------ //
 ...
 * @param mixed $idc
 * @return mixed|void = true o false
 */
function rmdp_check_access($idc)
{
    ...
    [$rtn] = $xoopsDB->fetchRow($xoopsDB->query('SELECT acceso FROM ' . $xoopsDB->prefix('rmdp_categos') . " WHERE id_cat='$idc'"));
