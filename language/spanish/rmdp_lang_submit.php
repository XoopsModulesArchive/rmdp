...
// NUEVO EN 1.3 //
define('_RMDP_MAXSIZE', 'Tamaño máximo: <strong>%s</strong>');
define('_RMDP_FFILEURL_DESC', 'No es necesario si se indica el campo "Archivo"');
define('_RMDP_FFILEURL', 'Archivo (URL):');
define('_RMDP_FIMGURL', 'Im&aacute;gen (URL):');
define('_RMDP_FIMGURL_DESC', 'No es necesario si se indica el campo "Imágen"');
define('_RMDP_SELECT', 'Seleccionar...');
define('_RMDP_FSIZE_DESC', 'Si se ha indicado un archivo local se calcula automáticamente.');
define('_RMDP_ITEMMIR_TITLE', 'Título %s:');
define('_RMDP_ITEMMIR_URL', 'URL de Archivo %s:');
define('_RMDP_MIRRORS_TITLE', 'Otros Formatos o Sitios R&eacute;plica (opcionales)');
