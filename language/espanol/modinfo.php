...
//////////////////////////////////////////////////////////////////////////////
// $Id: modinfo.php,v 1.7 23/11/2005 13:48:15 BitC3R0 Exp $                 //
// ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------ //
//////////////////////////////////////////////////////////////////////////////
define('_MI_RMDP_NAME', 'RMSOFT Downloads Plus 1.7');
define('_MI_RMDP_DESC', 'Módulo para la administraci&oacute;n avanzada de software');
...
define('_MI_RMDP_SHOWCATIMG', 'Mostrar imgenes de las categoras');
...
define('_MI_RMDP_CATWITHNEWS', 'Nmero de Categor&iacute;as con novedades en la p&aacute;gina principal:');
define('_MI_RMDP_SPONSORNUM', 'Nmero de descargas patrocinadas a mostrar:');
define('_MI_RMDP_FAVORITESNUM', 'Nmero de descargas a mostrar en Favoritos:');
define('_MI_RMDP_POPULARNUM', 'Nmero de descargas a mostrar en Populares:');
...
define('_MI_RMDP_SUBCATLIMIT', 'Nmero de subcategor&iacute;as para mostrar:');
...
define('_MI_RMDP_SHOTCOLS', 'Nmero de columnas para tablas de pantallas:');
define('_MI_RMDP_TOPPOP', 'Nmero de descargas populares a mostrar');
define('_MI_RMDP_TOPFAV', 'Nmero de descargas favoritas a mostrar');
define('_MI_RMDP_TOPRATE', 'Nmero de descargas mejor valoradas a mostrar');
define('_MI_RMDP_SENDMAIL', 'Notificar por email cuando se envia una descarga');
define('_MI_RMDP_BODYMAIL', 'Contenido del email de aceptacin de descargas:');
define('_MI_RMDP_BORKENINFO', 'Texto informativo para usuarios que desean reportar una descarga errnea');
define('_MI_RMDP_SENDNOTITY', 'Enviar notificacin por inactividad:');
define('_MI_RMDP_SENDNOTITY_DESC', 'Un email ser enviado al publicador/autor de la descarga.');
define('_MI_RMDP_ADMINNOTIFY', 'Enviar notificacin al Administrador:');
define('_MI_RMDP_DAYSNOTIFY', 'Das de inactividad antes de enviar una notificacin:');

// VERSION 1.7
define('_MI_RMDS_SHOWFIELDS', 'Campos que se mostrarán para enviar una descarga:');
define('_MI_RMDP_VEROP', 'Versión');
define('_MI_RMDP_LICOP', 'Licencia');
define('_MI_RMDP_SIZEOP', 'Tamaño');
define('_MI_RMDP_AUTHOROP', 'Datos de Página del Autor');
define('_MI_RMDP_OSOP', 'Plataformas');
define('_MI_RMDP_SHOWSPON', 'Mostrar Descargas Patrocinadas:');
define('_MI_RMDP_MYSENDRES', 'Resultados por página en "Mis Envíos":');
...
////////////////////////////////////////////
// NUEVOS O MODIFICADOS EN LA VERSIN 1.3 //
////////////////////////////////////////////
define('_MI_RMDP_BANNERS', 'Activar banners en el mdulo:');
define('_MI_RMDP_BANNERS_CODE', 'Cdigo para mostrar banners:');
define('_MI_RMDP_CONFIGCAT_IMGS', 'Configuracin de Im&aacute;genes');
define('_MI_RMDP_CONFIGCAT_DOWNS', 'Configuracin de Descargas');
define('_MI_RMDP_SENDFILES', 'Activar carga de archivos:');
define('_MI_RMDP_SENDFILE_DESC', '<span style="font-size: 10px;">Al activar esta opcin los usuarios podrn subir los archivos directamente al servidor</span>');
define('_MI_RMDP_SENDIMG', 'Activar carga de imgenes:');
define('_MI_RMDP_SENDIMG_DESC', 'Al activar esta opcin los usuarios podrn subir sus imgenes directamente al servidor');
define('_MI_RMDP_SHOTLINK_DESC', '<span style="font-size: 10px;">Si se activa los usuarios sern enviados directamente al archivo de imgen cuando den click en una pantalla. De lo contrario las imgenes se cargan en una pgina del mdulo.</span>');
define('_MI_RMDP_SOFTDIR', 'Directorio para carga de Software:');
define('_MI_RMDP_SOFTDIR_DESC', '<span style="font-size: 10px;">Indica la ruta del directorio donde se almacenarn los archivos enviados por los usuarios. Este directorio debe existir en el servidor.<br>Tags tiles:<br>{XOOPS_PATH} = Ruta de XOOPS<br>{RMDP_PATH} = Ruta del mdulo</span>');
define('_MI_RMDP_MIRRORSNUM', 'Nmero mximo de sitios rplica:');
define('_MI_RMDP_MIRRORSNUM_DESC', '<span style="font-size: 10px;">Nmero de sitios rplica para una descarga o bien, nmero de formatos diferentes de archivos para una descarga.</span>');
define('_MI_RMDP_FILESIZE', 'Tama&ntilde;o mximo del archivo a subir:');
define('_MI_RMDP_SIZEUNIT', 'Unidad de conversin para el tam&ntilde;o de Archivo:');
...
define('_MI_RMDP_BODYMAIL_DESC', '<span style="font-size: 10px;">Etiquetas tiles:<br>{USER} = Nombre del Usuario.<br>{DOWN} = Nombre de la descarga.<br>{LINK} = Vnculo a la descarga.<br>{URL} = URL del sitio.</span>');
