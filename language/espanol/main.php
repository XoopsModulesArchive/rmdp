...
define('_RMDP_DOWNS_INCATS_DESC', 'Descargas recientes en la categora %s de %s');
define('_RMDP_DOWNS_LASTDESC', 'Ultimas descargas en el sitio');
define('_RMDP_DOWNS_ERRHEADERS', 'Lo sentimos, ocurri un error al procesar el archivo.\nPor favor vuelve a intentarlo');
define('_RMDP_SUBJECT_NOTIFY', 'Aviso de inactividad de descarga');
...
if ('downloads' == $rmdp_location) {
    ...
    define(
        '_RMDP_BROKEN_BODY',
        "Hola %s:\n\nUna descarga tuya ha sido reportada como errnea. Te suplicamos comprobar los datos cuanto antes. Para hacerlo puedes ingresar a:\n\n%s\n\nTambien puedes comprobar todas tus descargas en "
        . XOOPS_URL
        . "/modules/rmdp/mysend.php \n\nComentario del usuario:\n\n \"%s\" \n\nAtentamente:\nEl equipo de Xoops Mxico\nwww.xoops-mexico.net"
    );

    define('_RMDP_BROKEN_BODYADMIN', "El usuario %s ha reportado una descarga como errnea. Puedes revisar los datos en:\n\n%s\n\n O puedes ver la descarga en\n\n%s. \n\nComentario del usuario: \n\n\"%s\"");

    define('_RMDP_BROKEN_SEND', 'Tu reporte ha sido enviado. Gracias');

    define('_RMDP_BROKEN_SUBJECT', 'Reporte de descarga errnea');

    define('_RMDP_BROKEN_NOREPORT', 'No has escrito ning&uacute;n mensaje para el reporte. Por favor intentalo nuevamente');
}
