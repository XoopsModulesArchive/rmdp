...
// Modulo XOOPS que permite el control y distribucin avanzado de           //
// descargas.                                                               //
// ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------ //
// Visita http://www.xoops-mexico.net para obtener los ltimos mdulos      //
// de Red Mxico Soft.                                                      //
//                                                                          //
// For more modules from Red Mxico Soft visit http://www.xoops-mexico.net  //
// ------------------------------------------------------------------------ //
//////////////////////////////////////////////////////////////////////////////
...
/**
 * Declaraciones para la barra de navegacin
 */
...
define('_AM_RMDP_ERRMOVEFILE', 'Ocurri un error al intentar cargar el archivo. Por favor verifica que el directorio "%s" tenga permisos de escritura');
...
if ('indice' == $location) {
    ...
    define('_AM_RMDP_FIMGURL', 'Im&aacute;gen (URL):<br><span style="font-size: 10px;">No se necesita si se ha especificado un archivo de imgen.</span>');

    define('_AM_RMDP_SELECT', 'Seleccionar...');

    define('_AM_RMDP_ERRNAME', 'Error: No especificaste el nombre de la categor&iacute;a.');

    define('_AM_RMDP_ERREXIST', 'Error: Ya existe una categora con el mismo nombre.');

    define('_AM_RMDP_ERRNOEXIST', 'Error: No existe la categora especificada.');
    ...
    define('_AM_RMDP_SHOWNEWS', 'Mostrar novedades en la pgina principal:');
    ...
    define('_AM_RMDP_CURRENTFFILE', 'Archivo Actual:');

    define('_AM_RMDP_RATING', 'Calificaci&oacute;n:');

    define('_AM_RMDP_FIMG', 'Im&aacute;gen:');

    define('_AM_RMDP_CURRENTFIMG', 'Im&aacute;gen Actual:');
    ...
    define('_AM_RMDP_FSECURE', 'Este archivo se descarga de modo seguro:');

    define('_AM_RMDP_FSECURE_DESC', 'Al activar esta opcin los usuario no podrn conocer la ubicacin fsica del archivo.');
    ...
    define('_AM_RMDP_FIMGURL_DESC', 'No es necesario si se indica el campo "Imgen"');

    define('_AM_RMDP_FSIZE_DESC', 'Si se ha indicado un archivo local se calcula automticamente.');

    define('_AM_RMDP_ITEMMIR_TITLE', 'Ttulo %s:');

    define('_AM_RMDP_ITEMMIR_URL', 'URL de Archivo %s:');

    define('_AM_RMDP_ERRSIZE', 'El tamao del archivo es mayor al tamao permitido');

    define('_AM_RMDP_MAXSIZE', 'Tamao mximo: <strong>%s</strong>');
    ...
    define('_AM_RMDP_ERRVERSION', 'Por favor indica la versin del archivo');

    define('_AM_RMDP_ERRVFILE', 'Indica el archivo a descargar');

    define('_AM_RMDP_ERRCATEGO', 'Selecciona una categora para esta descarga');

    define('_AM_RMDP_ERRDESC', 'Debes proporcionar al menos una descripcin corta para esta descarga');
    ...
    define('_AM_RMDP_CONFIRM', 'Realmente deseas eliminar esta descarga?<br><br>Sern eliminadas todas las pantallas de esta descarga.');
    ...
    // Seccin para las capturas de pantalla
    ...
    define('_AM_RMDP_SHOTERRSB', 'Error: Especifica la imgen pequea y la imgen grande');
    ...
    define('_AM_RMDP_FIMG', 'URL de la Imgen:');
