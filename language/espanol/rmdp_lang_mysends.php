...
define('_RMDP_FFILE_DESC', 'Tama&ntilde;o máximo: <strong>%s</strong>');
define('_RMDP_FILE_URL', 'Archivo (URL):');
define('_RMDP_IMG_URL', 'Imágen (URL):');
define('_RMDP_MIRRORS_TITLE', 'Sitios Réplica (<em>Opcionales</em>)');
define('_RMDP_ITEMMIR_TITLE', 'Título:');
define('_RMDP_ITEMMIR_URL', 'URL de Archivo:');
define('_RMDP_MAIL_SUBJECT', 'Solicitud de modificación de descarga');
define('_RMDP_SHOT_IMG', 'Imágen:');
define('_RMDP_SHOT_IMG_DESC', 'No es necesario si se especifica un archivo para subir.');
define('_RMDP_ERR_MOVE', 'Error al cargar el archivo. Por favor vuelve a intentarlo o notifica al administrador de este error.');
define('_RMDP_CONFIRM_DELETE', '¿Realmente deseas eliminar esta pantalla?');
define('_RMDP_SHOT_DELETED', 'Pantalla eliminada correctamente');
...
define('_RMDP_MAIL_BODY', "Un usuario ha solicitado la modificación de una descarga.\n\nPara revisar los detalles de esta descarga sigue el link de abajo:\n\n");
