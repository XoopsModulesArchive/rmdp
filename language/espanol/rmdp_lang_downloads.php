...
//////////////////////////////////////////////////////////////////////////////
// $Id: rmdp_lang_downloads.php,v 1.5 23/11/2005 17:48:46 BitC3R0 Exp $     //
// ------------------------------------------------------------------------ //
// RMSOFT Downloads Plus 1.5                                                //
// Copyright  2005. Red Mexico Soft                                        //
// <http:www.redmexico.com.mx>                                             //
// Modulo XOOPS que permite el control y distribucin                       //
...
define('_RMDP_PUBLISHER_DESC', 'Descripci&oacute;n del Editor');
define('_RMDP_REPORT_BROKEN', 'Reportar enlace roto');
// NUEVO EN VERSION 1.3 //
define('_RMDP_OTHER_MIRRORS', 'Sitios de descarga alternativos');
define('_RMDP_TRY_ANOTHER', 'Intenta algun <strong>enlace alternativo</strong> para esta descarga.');
define('_RMDP_MIRROR_PRIMARY', 'Sitio Principal');
define('_RMDP_FILE_TYPE', 'Archivo <strong>.%s</strong>');
define('_RMDP_THANKS_DOWN', 'Gracias por descargar');
...
define('_RMDP_LANG_INFO', 'Informaci&oacute;n');
define('_RMDP_LANG_IMAGE', 'Im&aacute;gen');
